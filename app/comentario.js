function ComentarioObject(myTitle, myDescription) {
...
function getComentarioList()
{
  try
  {
    ...
    alert(myData.toJsonString());
     ...
     jQuery.ajax({
           type: "POST",
           url: "https://bestmedicineprice.appspot.com/_ah/api/comentario_api/v1/comentario/list",
           data: myData.toJsonString(),
           contentType: "application/json; charset=utf-8",
           dataType: "json",
           success: function (response) {
