function LaboratorioObject(myTitle, myDescription) {
...
function getLaboratorioList()
{
  try
  {
    ...
    alert(myData.toJsonString());
     ...
     jQuery.ajax({
           type: "POST",
           url: "https://bestmedicineprice.appspot.com/_ah/api/laboratorio_api/v1/laboratorio/list",
           data: myData.toJsonString(),
           contentType: "application/json; charset=utf-8",
           dataType: "json",
           success: function (response) {
